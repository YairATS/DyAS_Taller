<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Views/Site4.Master" CodeBehind="ClientesView.aspx.vb" Inherits="WebApplication8.ClientesView" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ProyectoTallerConnectionString %>" SelectCommand="SELECT * FROM [Clientes]"></asp:SqlDataSource>
</asp:Content>
